...
function Itemdetails() {
    ...
    //   Related Items
      ...
      const relateditems = items.filter((item) => item.attributes.category  === category)
    ...
    <div>
        <div className='flex flex-col md:flex-row mt-4 '>        
            ...
            <div className='md:w-[60%] w-full flex flex-col mt-4 space-y-2 px-4 pr-2  gap-2 md:pr-20'>
                ...
                <p className= 'pt-4 line-clamp-3'>{item?.attributes?.shorttext}</p>
                ...
                <div className={ productdescription? 'block mt-4' : 'hidden' }>
