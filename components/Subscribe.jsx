...
function Subscribe() {
  ...
  return (
    <div className='flex flex-col my-4 mt-4 justify-center w-full max-w-6xl mx-auto'>
        ...
        <div className='w-[75%] flex rounded-md  justify-center divide-x-[1px] divide-gray-400 mx-auto p-2 mt-2 bg-gray-300/80'>
          <InputBase
